...
describe('Organization Permissions', () => {
    ...
    test('user organization admin should get your service permissions', async done => {
        ...
        const userOrganizationPermission = await service.userServicePermissions({ serviceName: Services.AFFILIATE},context, trx);

        const serviceByName = await ServicesService.getServiceByName(Services.AFFILIATE, trx);
    ...
    test('user organization admin should get your permissions by name', async done => {
        ...
        const userServicePermission = await service.userServicePermissions(userServicePermissionsPayload,context, trx);
    ...
    test('user service analyst should get your permissions', async done => {
        ...
        let otherContext = {client: otherUserToken, organizationId: organizationCreated.id, isOrganizationAdmin: false}

        const userOrganizationPermission = await service.userServicePermissions({ serviceName: Services.AFFILIATE},otherContext, trx);
