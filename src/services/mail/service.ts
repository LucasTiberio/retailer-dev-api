                                                    ...
                                                    <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                            ...
                                                            <td class="col px-16" bgcolor="#FFFFFF" align="left" width="100%" style="padding: 48px 48px 0 48px;" >
                                                                ...
                                                                <a href="${frontUrl}/verification/${data.hashToVerify}" class="inter btn confirmation" style="text-align: center;cursor: pointer;text-decoration: none;">Confirmar email e ativar conta</a>
