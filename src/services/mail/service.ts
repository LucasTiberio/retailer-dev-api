                                                    ...
                                                    <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                            ...
                                                            <td class="col px-16" bgcolor="#FFFFFF" align="left" width="100%" style="padding: 48px 48px 0 48px;" >
                                                                ...
                                                                <a href="${frontUrl}/verification/${data.hashToVerify}" class="inter btn confirmation" style="width: 330px;margin:48px auto;color:#ffffff;text-align:center;font-weight:700;font-weight:bold;font-size:18px;line-height:24px;box-sizing:border-box;display:block;padding:16px 32px;width:198px;height:56px;background:linear-gradient(200.34deg, #3C5ED9 -2.42%, #3B24A8 79.51%);border-radius:6px;text-align: center;cursor: pointer;text-decoration: none;">Confirmar email e ativar conta</a>
                                                      ...
                                                      <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                        <tr>
                                                          <td class="col px-16" bgcolor="#FFFFFF" align="left" width="352" style="padding: 48px 48px 32px 48px;" >
                                                            ...
                                                            <a href="${frontUrl}/recovery-password/change-password/${data.hashToVerify}" class="inter btn newpassword" style="width: 260px;margin:48px auto;color:#ffffff;text-align:center;font-weight:700;font-weight:bold;font-size:18px;line-height:24px;box-sizing:border-box;display:block;padding:16px 32px;width:198px;height:56px;background:linear-gradient(200.34deg, #3C5ED9 -2.42%, #3B24A8 79.51%);border-radius:6px;color: #ffffff; text-align: center;cursor: pointer;text-decoration: none;">Escolher nova senha</a>
                                          ...
                                          <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tr>
                                              <td class="col px-16" bgcolor="#FFFFFF" align="left" width="352" style="padding: 48px 24px 32px 24px;" >
                                                ...
                                                <a href="${frontUrl}/member-invited/${data.hashToVerify}/accept" class="inter btn" style="margin:48px auto;color:#ffffff;text-align:center;font-weight:700;font-weight:bold;font-size:18px;line-height:24px;box-sizing:border-box;display:block;padding:16px 32px;width:198px;height:56px;background:linear-gradient(200.34deg, #3C5ED9 -2.42%, #3B24A8 79.51%);border-radius:6px;color: #ffffff; text-align: center;cursor: pointer;text-decoration: none;margin-bottom: 10px">Aceitar convite</a>
                                          ...
                                          <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                            <tr>
                                              <td class="col px-16" bgcolor="#FFFFFF" align="left" width="352" style="padding: 48px 24px 32px 24px;" >
                                                ...
                                                <a href="${frontUrl}/member-invited/${data.hashToVerify}/accept" class="inter btn" style="margin:48px auto;color:#ffffff;text-align:center;font-weight:700;font-weight:bold;font-size:18px;line-height:24px;box-sizing:border-box;display:block;padding:16px 32px;width:198px;height:56px;background:linear-gradient(200.34deg, #3C5ED9 -2.42%, #3B24A8 79.51%);border-radius:6px;color: #ffffff; text-align: center;cursor: pointer;text-decoration: none;">Aceitar convite</a>
