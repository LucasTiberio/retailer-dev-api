...
describe("affiliate graphql", () => {
  ...
  test("organization admin handle organization commission by provider type graphql", async (done) => {
    ...
    expect(response.body.data.handleOrganizationCommission).toEqual(
      expect.objectContaining({
        id: expect.any(String),
        departmentId: organizationCommissionInput.departmentId,
        commissionPercentage: organizationCommissionInput.commissionPercentage,
